...
--
-- Client :  localhost
-- Généré le :  Ven 30 Avril 2021 à 14:10
...
(7, 'dgfhdfhdf', 'dfgdfgdfgdf', 'Appartement', '20210430135138_app.jpg', 15, 850, '2021-04-30 13:50:39', 0, 2);
...
INSERT INTO `t_user` (`idUser`, `usePseudo`, `useFirstname`, `useName`, `usePassword`, `useMail`, `usePhone`, `useImage`, `useProfilePref`, `useCreatedOn`) VALUES
(2, 'admin', '', '', '$2y$10$mNdPUfVHLknw79ZtREtSqeEVBfkgjBXeipvSOr.ZnaEqcRChDgDWS', '', '', '20210103123527_feu.gif', 1, '2021-04-27 10:00:00'),
(3, 'test', 'testo', 'test', '$2y$10$W5zkzbeWEQVvFvsKFSGAHuijP.c0.jXxI9hXwjhT/SCeIEZqfYxui', '', '', '20210429144532_chat.gif', 4, '2021-04-30 16:04:46'),
(4, 'test1', '', '', '$2y$10$bZgUepbYfIt24bc3.wcAr.DDIEXkQL6vcp4gMceqh4GAgb7mt7//6', '', '', 'defaultUserPicture.png	', 3, '2021-04-30 16:04:46'),
(17, 'test2', '', '', '$2y$10$MrjDw26STBqkDBVGyivyzOYcpfQ9KsDnv.tRKUPmH6BnY0pfxvVlu', NULL, NULL, 'defaultUserPicture.png	', 1, '2021-04-30 16:04:46');
...
--
ALTER TABLE `t_appartement`
  MODIFY `idAppartement` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `t_user`
  MODIFY `idUser` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
